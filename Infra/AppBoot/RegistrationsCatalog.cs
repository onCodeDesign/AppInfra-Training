...
/// </para>
/// </summary>
internal class RegistrationsCatalog : IEnumerable<ServiceDescriptor>
{
    private readonly LinkedList<Registration> registrations = new LinkedList<Registration>();

    public void Add(ServiceDescriptor serviceInfo, int priority)
    {
    ...
    private void Add(Registration newReg)
    {
        ...
        while (current != null)
        {
            ...
            if (reg.Service.ImplementationType == newReg.Service.ImplementationType)
            {
                isNewFrom = false;
    ...
    {
        public Registration(ServiceDescriptor service, int priority)
        {
            Service = service;
            Priority = priority;
        }
