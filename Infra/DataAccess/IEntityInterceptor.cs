    ...
    where T : class
{
    ...
    /// <param name="unitOfWork">A reference to the unitOfWork that read this entry. It may be used to read additional data.</param>
    void OnSave(IEntityEntry<T> entry, IUnitOfWork unitOfWork);
    ...
    /// <param name="unitOfWork">A reference to the unitOfWork that read this entry. It may be used to read additional data.</param>
    void OnDelete(IEntityEntry<T> entry, IUnitOfWork unitOfWork);
}
...
public interface IEntityInterceptor
{
    ...
    /// <param name="entry">The entity being saved</param>
    /// <param name="unitOfWork">A reference to the unitOfWork that read this entry. It may be used to read additional data.</param>
    void OnSave(IEntityEntry entry, IUnitOfWork unitOfWork);
    ...
    /// <param name="entry">The entity being deleted</param>
    /// <param name="unitOfWork">A reference to the unitOfWork that read this entry. It may be used to read additional data.</param>
    void OnDelete(IEntityEntry entry, IUnitOfWork unitOfWork);
}